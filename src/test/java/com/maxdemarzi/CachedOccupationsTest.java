...
public class CachedOccupationsTest {
    @Rule
    ...
    public void shouldImportTitles() {
        ...
        HTTP.Response response = HTTP.POST(neo4j.httpURI().resolve("/v1/import/titles_cache_occupations" + file.getAbsolutePath()).toString());
